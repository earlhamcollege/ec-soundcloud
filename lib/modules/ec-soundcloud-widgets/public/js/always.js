    ...
    construct: function(self, options) {
        self.play = function ($widget, data, options) {
            ...
            $.get('/modules/ec-soundcloud-widgets/soundcloud?api_key='+data.api_key+'&client_id='+encodeURIComponent(data.api_user), function(results) {
                ...
                $.get("https://api.soundcloud.com/users/"+data.client_id+"/tracks?client_id="+encodeURIComponent(data.api_key), function(tracks_result) {
                ...
                $.get("http://api.soundcloud.com/users/"+data.client_id+"?client_id="+encodeURIComponent(data.api_key), function(account_result) {
            ...
            function renderFocus(tracks, data){
                ...
                $.get("https://api.soundcloud.com/tracks/"+ track_id[1] +"?client_id="+encodeURIComponent(data.api_key), function(result) {
