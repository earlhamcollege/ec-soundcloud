...
module.exports = {
        ...
        options.arrangeFields = [
            {
              name:'user',
              label:'User Settings',
              fields: ['api_key', 'user_name']
            },
            {
              name:'display',
              label: 'Display Settings',
              fields: ['feature_count','toggle_account_desc','preferences']
            },
            {
                name:'player',
    ...
    construct: function (self, options) {
        ...
        self.route('get', 'soundcloud', function (req, res) {
            var url = "https://api.soundcloud.com/resolve?url=http://soundcloud.com/"+ req.query.client_id+"&client_id="+req.query.api_key ;
